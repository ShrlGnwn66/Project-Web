...
<body>
    <section class="header">
        <nav>
            ...
            <div class="nav-links" id="navLinks">
                ...
                <ul>
                    ...
                    <li><a href="javascript:alert('Anda Harus Login Terlebih Dahulu Untuk Mengakses Halaman Ini !!')">KAMAR</a></li>
        ...
        <div class="text-box">
            ...
            <p>Kost Putra B3, Jalan Mastrip Gang VII, Krajan Timur, Sumbersari, Kec. Sumbersari, Kabupaten Jember, Jawa Timur 68121</p>
        </div>
    </section>
    ...
    <section class="footer">
        ...
        <p>Developed <i class="fa fa-heart-o"></i> By Team 2</p>
    </section>
</body>
