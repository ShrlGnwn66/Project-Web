        ...
        <div class="form-content">
            <div class="form-items">
                ...
                <form action="" method="post">
                    ...
                    <!-- memilih jenis kamar -->
                    <div class="col-md-12 ">
                        <select name="jeniskamar" class="form-select mt-3" required>
                            <option selected disabled value="">Jenis Kamar</option>
                            <option value="Kamar A">Kamar A</option>
                            <option value="Kamar B">Kamar B</option>
                            <option value="Kamar C">Kamar C</option>
                            <option value="Kamar D">Kamar D</option>
                        </select>
                    </div>
